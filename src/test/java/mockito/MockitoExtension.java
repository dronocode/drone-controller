...
/**
 * {@code MockitoExtension} showcases the {@link InstancePostProcessor} and {@link MethodParameterResolver} extension
 * points of JUnit 5 by providing dependency injection support at the field level via Mockito's {@link Mock @Mock}
 * annotation and at the method level via our demo {@link InjectMock @InjectMock} annotation.
 *
 * @since  5.0
 */
